...
// *********
@StartableByRPC
class CreateMyTokenFlow(private val recipient: String, private val msg: String) :
    ...
    override fun call(): UniqueIdentifier {
        ...
        val tokenState = CustomTokenState(ourIdentity.toString(), recipient, msg, ourIdentity, 0, uuid)
